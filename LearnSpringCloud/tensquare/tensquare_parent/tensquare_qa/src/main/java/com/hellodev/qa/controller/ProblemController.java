package com.hellodev.qa.controller;
...
import com.hellodev.qa.service.ProblemService;
...
public class ProblemController {
	...
	public Result newList(@PathVariable String labelId, @PathVariable int page, @PathVariable int size) {
		...
		return Result.builder()
				...
				.message("查询成功")
				.data(new PageResult<Problem>(pageData.getTotalElements(), pageData.getContent()))
				.build();
	}
